...
//URI: MLab
mongoose.connect('mongodb://localhost:27017/test_for_chicago', { useNewUrlParser: true,useUnifiedTopology: true})
...
router.route('/users')
    ...
    .get(function (req, res) {
        ...
        User.findById(req.params.produto_id, function(error, produto) {
            if(error)
